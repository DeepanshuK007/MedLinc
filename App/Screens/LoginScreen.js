...
export default function Login() {
	...
	return (
		<View style={styles.container}>
			...
			<Image source={img1} style={styles.appImage} />
			{/* <Text>Open up App.js to start working on your app!</Text>
      <StatusBar style="auto" /> */}
			<View style={styles.headingWrap}>
				<Text style={styles.heading1}> Lincmed </Text>
			...
			<View style={{ marginTop: 20 }}>
				<Text style={{ textAlign: 'left', fontSize: 15, marginLeft: 20, marginTop: -20 }}> Email Address </Text>
				<TextInput
			...
			<View style={{ marginTop: 20 }}>
				...
				<TouchableOpacity>
					<Text style={{ textAlign: 'right', marginRight: 18, marginTop: 2 }}> Forget Password? </Text>
				</TouchableOpacity>
			</View>

			<View style={{ padding: 35, marginTop: -25 }}>
				<TouchableOpacity onPress={handleSubmit}>
					<Text style={styles.GoogleLogin}> Login </Text>
				</TouchableOpacity>
			</View>
			...
			<View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 15 }}>
				...
				<TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
					<Text style={{ color: '#013220', fontWeight: 'bold' }}> Sign Up </Text>
				</TouchableOpacity>
			</View>
		</View>
	);
